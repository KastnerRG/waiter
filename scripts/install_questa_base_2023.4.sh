...
PROMPT_TARG="F"
MIPPATH="$HOME/installers/questa/questa_base-2023-4/installer/install.aol"
...
MIPEXTRAARGS=
MIPTARG="/tools"
MIPSRC="$HOME/installers/questa/questa_base-2023-4/installer/install.aol"
while [ $# -gt 0 ];
do
   if [ "$1" = "-tgt" ]; then
      shift
...
<batchFile>
	<source value="$HOME/installers/questa/questa_base-2023-4/installer/install.aol"/>
